...
<IfcAlert>It's simply a question of which repository you save your code to.</IfcAlert>
...
<IfcCard>The thought that we cannot compete with them is a thought that only benefits them. Are we going to admit that we have already lost before we try?</IfcCard>
