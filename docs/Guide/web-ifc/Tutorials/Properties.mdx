...
<IfcCard>
    We are using this example as a <a href="https://github.com/IFCjs/hello-world/tree/main/examples/web-ifc/ifc-to-json/frontend">base</a> and will be making additions to it
</IfcCard>
