...
<IfcCard>🍰 Working with JSON is also more convenient as you can put the JSON file into a database like MongoDB.</IfcCard>
<IfcAlert>
...
<IfcAlert>💻🧑 Go ahead and save this in a front-end database and make your application way way faster.</IfcAlert>
