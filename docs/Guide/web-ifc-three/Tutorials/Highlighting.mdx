...
### Single subset
  ...
  🐭
It is very common that when the user hovers the mouse over an element, the element is softly illuminated. We can achieve this effect using <a href="https://ifcjs.github.io/info/docs/Guide/web-ifc-three/api#createsubset" target="_self">createSubset</a>.
...
In this example we are going to associate it to **double click** to simulate the effect of highlighting objects when they are selected.
