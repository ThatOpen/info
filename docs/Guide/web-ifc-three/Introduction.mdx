...
<IfcCard>🐣 It's super easy to use.</IfcCard>

<IfcCard>
  🎩 It's the <a href="https://threejs.org/examples/webgl_loader_ifc.html">official IFCLoader of Three.js</a>.
</IfcCard>

<IfcCard>🚀 It's very efficient, being able to display thousands of objects at 60 fps in a browser. It can display multiple models, change materials and filter items.</IfcCard>

<IfcCard>🧠 It can get and traverse the spatial structure tree of multiple files. Also, it can access the properties of all the items, both clicking on them in the 3d view and with smart filters.</IfcCard>
...
<IfcAlert>Web-ifc is way more flexible but requires more knowledge of the IFC schema and a greater implementation effort.</IfcAlert>
...
<IfcCard icon="⏳" title="Slight delay">
