...
<IfcCard>BIM programming will allow you to create your own tools, automate processes, create new businesses and qualify for better jobs.</IfcCard>

<IfcImage hideSource={true} image={<img src={require("@site/static/img/clipart/crash-course.png").default} alt="PC image"></img>}></IfcImage>
