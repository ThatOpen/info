...
Who are we? A group of developers who want to improve the construction industry in their spare time. The project started in 2021 with [Tom](https://github.com/tomvandig), [Harry](https://github.com/harrycollin) and me and has been growing ever since, with are more and more people and companies willing to change the situation in the sector and commit to a **real open BIM**.
