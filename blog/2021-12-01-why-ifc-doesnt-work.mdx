...
Data is being lost in the transfer of these documents from software to software, some geometry may not be displaying as it should or federated models are becoming out of place are just some of the pitfalls that many of us have experienced on projects of all sizes.
  ...
  <IfcCard>
🤷‍♂️
We start to see and ask questions like:
Why does IFC work so badly?
Is open BIM technology unviable?
</IfcCard>
...
👨‍💻👨‍💻👨‍💻
Others say the problem is the schema. It is true that IFC is complex and the documentation is dry, but IFC.js started between 3 people in their spare time,  implementing something that has extraordinary potential in less than a year.

The problem seems to be that **no large software company has a commercial interest in IFC**. In reality, the ultimate goal of all of them is to convince the user to use their entire ecosystem. The IFC is, in many cases, apartialy flawed solution for relying on other tools that they may not have had time to implement IFC correctly or whose business is not in line with the interest of IFC.
...
🤝 Last week there was a round table discussion at the [Typsa](https://www.typsa.com/en/) offices where there was an [open conversation](https://teys.es/01-hackaton-typsa-ue4-actividades/) with representatives from [Ferrovial](https://www.ferrovial.com/) and [FCC](https://www.fcc.es/), and we all agreed that maybe it was time for us to step up to the plate and develop in the world of BIM software to defend our own interests.
